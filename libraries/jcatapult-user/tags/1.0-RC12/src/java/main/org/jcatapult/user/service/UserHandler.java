...
public interface UserHandler<T extends User, U extends Role> {
     ...
     *          the roles.
     */
    Map<String, int[]> getDefaultAssociations();

    /**
     * @return  The set of default roles that the User should have.
     */
    Set<U> getDefaultRoles();
     ...
     */
    void associate(T user, Map<String, int[]> associations);
     ...
     */
    ErrorList validate(T user, Map<String, int[]> associations, boolean existing, String password,
