...
public class JPAPersistenceService implements PersistenceService {
     ...
     * {@link org.jcatapult.persistence.domain.SoftDeletable} and appends "where eb.deleted = false" if the includeDeleted is false.
     *
     * @param   type The type to find.
     * @param   includeDeleted Determines if this should return all the instances of the Object
     *          including those instances that are marked as deleted and are {@link org.jcatapult.persistence.domain.SoftDeletable}
     *          objects.
     * @return  The list.
     */
    ...
    /**
     * This is the internal method that handles finding by type. If the type is {@link org.jcatapult.persistence.domain.SoftDeletable}
