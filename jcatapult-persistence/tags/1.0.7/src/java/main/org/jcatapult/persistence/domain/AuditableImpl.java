...
/**
 * <p> This class is an auditing persistable Object instance. Since Java is lacking multiple inheritance I had to force
 * this to extend TimeStampableImpl since that will be the most common case. This means that AuditableImpl will not have
 * the ability to handle objects with natural keys or other types of keys or not have time stamp information. </p> <p/>
 * <p> The user information is pulled from the {@link SecurityContext}. </p>
 *
