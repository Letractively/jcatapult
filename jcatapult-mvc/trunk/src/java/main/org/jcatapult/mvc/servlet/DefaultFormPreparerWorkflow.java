 ...
 */
public class DefaultFormPreparerWorkflow implements MVCWorkflow {
    private List<Workflow> workflows;

    @Inject
    public DefaultFormPreparerWorkflow(ActionMappingWorkflow actionMappingWorkflow, ScopeWorkflow scopeWorkflow,
            ParameterWorkflow parameterWorkflow, ActionInvocationWorkflow actionInvocationWorkflow) {
        workflows = asList(actionMappingWorkflow, scopeWorkflow, parameterWorkflow, actionInvocationWorkflow);
    }
