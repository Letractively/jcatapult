 ...
 */
@Ignore
public class WebBaseTest extends JCatapultBaseTest {
    ...
    public void setUp() {
        WebTestHelper.setUp();
        this.request = WebTestHelper.request;
        this.response = WebTestHelper.response;
        this.context = WebTestHelper.context;
        super.setUp();
    }
}