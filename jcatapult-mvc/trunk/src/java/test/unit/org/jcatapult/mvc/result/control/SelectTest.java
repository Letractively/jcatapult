...
public class SelectTest extends AbstractInputTest {
    ...
    public void testActionLess() {
        ...
        AbstractInput input = new Select(ee);
        run(input, null, "select", "foo.bar", "test", "Test",
    ...
    public void testAction() {
        ...
        AbstractInput input = new Select(ee);
        run(input, action, "select", "org.example.action.user.Edit", "user.addresses['work'].country", "Country",
