...
public class IndexTest {
    ...
    public void testNoSort() {
        List<GuestBookEntry> findResult = new ArrayList<GuestBookEntry>();
        ...
        EasyMock.expect(service.getNumberOfGuestBookEntries()).andReturn(0);
        ...
        assertSame(findResult, index.getGuestBookEntries());
    ...
    public void testPageAndNumber() {
        ...
        EasyMock.expect(service.getNumberOfGuestBookEntries()).andReturn(100);
        EasyMock.replay(service);
