...
*/
@ShortDescription("Creates a JSON action class.")
@LongDescription(
"""Creates an action that response via JSON. This can be used in Modules and WebApps.
...
""")
public class JSONActionScaffolder extends AbstractScaffolder {
  public void execute() {
  ...
  private void executeTemplates(String uri, String pkgName, String action, String result) {
