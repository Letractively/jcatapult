...
public class DbTools {
    ...
    private static final Logger logger = Logger.getLogger(DbTools.class.getName());
        ...
        /**
     * Runs the <b>disable-keys.sql</b> file from the jcatault-dbmgr JAR to turn of MySQL key constraints so
    ...
    /**
     * Runs the <b>enable-keys.sql</b> file from the jcatapult-dbmgr JAR to turn back on the MySQL key
