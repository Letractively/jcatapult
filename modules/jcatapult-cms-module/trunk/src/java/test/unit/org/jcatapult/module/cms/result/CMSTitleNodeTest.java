...
/**
 * <p>
 * This class tests the CMSTitleNode control.
 * </p>
 *
 * @author  Brian Pontarelli
 */
public class CMSTitleNodeTest extends BaseTest {
    @Inject
    CMSTitleNode cmsTitleNode;

    @Test
    public void testDefault() {
        ControlTestRunner runner = new ControlTestRunner();
        runner.test(cmsTitleNode).
            ...
            expect("<title>Default content</title>");
    }

    @Test
    public void testDatabase() {
        service.storeContent("localhost", "/page", "title", Locale.US, "Database content", ContentType.META, false, publisher);
        request.setUri("/page");
        ...
        runner.test(cmsTitleNode).
            ...
            withBody("Default content").
            expect("<title>Database content</title>");
    }
    ...
    public void testEditable() {
        ...
        runner.test(cmsTitleNode).
            ...
            withBody("Default content").
            expect("<title>Database content</title><script type=\"text/javascript\">top.CMS.register_meta_node('title', 'Database content', 'The page title', 'Title');</script>");
    }
}