...
# be executed from the target/tomcat/bin directory
...
##
# Set thet web app root. For new projects there will be a web directory
# for old projects there will be maven_compiled_webapp.
##
WEBAPP_ROOT=$PROJECT_ROOT/@WEB_DIR@


##
# Set the java opts environment variable
##
export JAVA_OPTS="-Drundir=$WEBAPP_ROOT -Xmx256M"
