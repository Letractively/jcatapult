 ...
 *
 * <p>
 * <strong>file-servlet.dir</strong> The location on disk where the files are
 * located.
 * </p>
 * <p>
 * <strong>file-servlet.prefix</strong> The URI prefix that the FileServlet is
 * mapped to in the web.xml file. This is important, because other parts of the
 * jcatapult framework depend on this value. So, it should be set correctly.
 * </p>
 *
...
public class FileServlet extends HttpServlet {
    ...
    public void init() throws ServletException {
        ...
        location = new File(configuration.getString("file-servlet.dir"));
        super.init();
    }
