...
/**
 * Base interface for all {@link org.jcatapult.migration.service.ArtifactService} classes
 *
 * User: jhumphrey
 * Date: Dec 12, 2007
 */
public abstract class BaseArtifactService implements ArtifactService {
     ...
     * @param databaseVersion the database version associated to {@link org.jcatapult.migration.domain.Artifact}
